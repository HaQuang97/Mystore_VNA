					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-md-10"><div class="form-group">
								<label for="inputLoai" class="col-sm-4 control-label"><strong> Chọn Sản Phẩm </strong></label>
								<div class="col-md-6">
							...
							<table class="table table-hover">
								...
								<tbody>
									@foreach($data as $row)
										<tr>
											<td>{!!$row->id!!}</td>
											<td> <img src="{!!url('public/uploads/products/'.$row->images)!!}" alt="sách" width="50" height="40"></td>
											<td>{!!$row->name!!}</td>
											<td>{!!$row->note!!}</td>
											<td>{!!$row->intro!!}</td>
											<td>{!!$row->price!!} Đ</td>
